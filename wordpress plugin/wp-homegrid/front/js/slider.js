...
function (e, t) {
    ...
    e.cleanData = function (t) {
        ...
        t = t.split(".")[1], i = a + "-" + t, r || (r = n, n = e.Widget), e.expr[":"][i.toLowerCase()] = function (t) {
            ...
            if (!this._createWidget) return new
            o(e, t);
...
function (e, t) {
    e.widget("ui.sortable", e.ui.mouse, {
        ...
        refreshPositions: function (t) {
            this.offsetParent && this.helper && (this.offset.parent = this
                ._getParentOffset());
    ...
    $.extend(Datepicker.prototype, {
        ...
        _updateDatepicker: function (e) {
            ...
            var r = this._getNumberOfMonths(e),
                i = r[1],
                s = 17;
            e.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width(""), i > 1 && e.dpDiv.addClass("ui-datepicker-multi-" + i).css("width", s * i + "em"), e.dpDiv[(r[0] != 1 || r[1] != 1 ? "add" : "remove") + "Class"]("ui-datepicker-multi"), e.dpDiv[(this._get(e, "isRTL") ? "add" : "remove") + "Class"]("ui-datepicker-rtl"), e == $.datepicker._curInst && $.datepicker._datepickerShowing &&
                e.input && e.input.is(":visible") && !e.input.is(":disabled") && e.input[0] != document.activeElement && e.input.focus();
            if (e.yearshtml) {
                var o = e.yearshtml;
                setTimeout(function () {
    ...
    e.widget("ui.slider", e.ui.mouse, {
        ...
        _mouseCapture: function (t) {
            ...
            return c.disabled ? !1 : (this.elementSize = {
                ...
                top: t.pageY - a.top - s.height() / 2 - (parseInt(s.css("borderTopWidth"), 10) || 0) - (parseInt(s.css("borderBottomWidth"), 10) || 0) +
...
function (e, t) {
    ...
    t.prototype = {
        ...
        listen: function () {
            this.$element.on("blur", e.proxy(this.blur, this)).on("keypress", e.proxy(this.keypress, this)).on("keyup", e.proxy(this.keyup, this)), this.eventSupported("keydown") && this.$element.on("keydown", e.proxy(this.keydown, this)), this.$menu
                .on("click", e.proxy(this.click, this)).on("mouseenter", "li", e.proxy(this.mouseenter, this))
        },
    ...
    r.prototype = {
        ...
        show: function (t) {
            this.picker.show(), this.height = this.component ? this.component.outerHeight() : this.element.outerHeight(), this.forceParse && this.update(), this.place(), e(window).on("resize", e.proxy(this.place, this)), t && (t.stopPropagation(), t.preventDefault()), this.element.trigger({
                type: "show",
                date: this.date
            })
        },
        ...
        setValue: function () {
            ...
            this.isInput ? this.element.prop("value", t) : (this.component && this.element.find("input").prop("value", t), this.element.data("date", t)), this.linkField && e("#" + this.linkField).val(this.getFormattedDate(this.linkFormat))
        },
        getFormattedDate: function (e) {
            return e == undefined && (e = this.format), s.formatDate(this.date, e, this.language, this.formatType)
        },
        setStartDate: function (e) {
            this.startDate = e || -Infinity, this.startDate !== -Infinity && (this.startDate = s.parseDate(this.startDate, this.format, this.language, this.formatType)), this.update(), this.updateNavArrows()
        },
        setEndDate: function (e) {
            this.endDate = e || Infinity, this.endDate !== Infinity && (this.endDate = s.parseDate(this.endDate, this.format, this.language, this.formatType)), this.update(), this.updateNavArrows()
        },
        ...
        place: function () {
            ...
            var t = parseInt(this.element.parents().filter(function () {
                ...
                n, r;
            this.component ? (n = this.component.offset(), r = n.left, this.pickerPosition == "bottom-left" && (r += this.component.outerWidth() - this.picker.outerWidth())) : (n = this.element.offset(), r = n.left), this.picker.css({
        ...
        update: function () {
            var e, t = !1;
            arguments && arguments.length && (typeof arguments[0] == "string" || arguments[0] instanceof Date) ? (e = arguments[0], t = !0) : e = this.isInput ? this.element.prop("value") : this.element.data("date") || this.element.find("input").prop("value") || new Date, e || (e = new Date, t = !1), this.date = s.parseDate(e, this.format, this.language, this.formatType), t && this.setValue(), this.date < this.startDate ? this.viewDate = new Date(this.startDate) : this.date > this.endDate ? this.viewDate = new Date(this.endDate) : this.viewDate = new Date(this.date), this.fill()
        },
        fillDow: function () {
        ...
        fill: function () {
            ...
            var n = new Date(this.viewDate),
                ...
                c = this.startDate !== -Infinity ? this.startDate.getUTCMonth() : -Infinity,
                h = this.endDate !== Infinity ? this.endDate.getUTCFullYear() : Infinity,
                p = this.endDate !== Infinity ? this.endDate.getUTCMonth() : Infinity,
                d = (new t(this.date.getUTCFullYear(), this.date.getUTCMonth(), this.date.getUTCDate())).valueOf(),
                v = new Date;
            this.picker.find(".datetimepicker-days thead th:eq(1)").text(i[this.language].months[o] + " " + r), this.picker.find(".datetimepicker-hours thead th:eq(1)").text(u + " " + i[this.language].months[o] + " " + r), this.picker.find(".datetimepicker-minutes thead th:eq(1)").text(u + " " + i[this.language].months[o] + " " + r), this.picker.find("tfoot th.today").text(i[this.language].today).toggle(this.todayBtn !== !1), this.updateNavArrows(), this.fillMonths();
            var m = t(r, o - 1, 28, 0, 0, 0, 0),
                g = s.getDaysInMonth(m.getUTCFullYear(), m.getUTCMonth());
            ...
            var b = [],
                w;
            while (m.valueOf() < y) {
                m.getUTCDay() == this.weekStart && b.push("<tr>"), w = "";
                if (m.getUTCFullYear() < r || m.getUTCFullYear() == r && m.getUTCMonth() < o) w += " old";
                else if (m.getUTCFullYear() > r || m.getUTCFullYear() == r && m.getUTCMonth() > o) w += " new";
                this.todayHighlight && m.getUTCFullYear() == v.getFullYear() && m.getUTCMonth() == v.getMonth() && m.getUTCDate() == v.getDate() && (w += " today"), m.valueOf() == d && (w += " active");
                if (m.valueOf() + 864e5 < this.startDate || m.valueOf() > this.endDate || e.inArray(m.getUTCDay(), this.daysOfWeekDisabled) !== -1) w += " disabled";
                b.push('<td class="day' + w + '">' + m.getUTCDate() + "</td>"), m.getUTCDay() == this.weekEnd && b.push("</tr>"), m.setUTCDate(m.getUTCDate() + 1)
            }
            this.picker.find(".datetimepicker-days tbody").empty().append(b.join("")), b = [];
            for (var E = 0; E < 24; E++) {
                var S = t(r, o, u, E);
                w = "", S.valueOf() + 36e5 < this.startDate || S.valueOf() > this.endDate ? w += " disabled" : a == E && (w += " active"), b.push('<span class="hour' + w + '">' + E + ":00</span>")
            }
            this.picker.find(".datetimepicker-hours td").html(b.join("")), b = [];
            for (var E = 0; E < 60; E += this.minuteStep) {
                var S = t(r, o, u, a, E);
                w = "", S.valueOf() < this.startDate || S.valueOf() > this.endDate ? w += " disabled" : Math.floor(f / this.minuteStep) == Math.floor(E / this.minuteStep) && (w += " active"), b.push('<span class="minute' + w + '">' + a + ":" + (E < 10 ? "0" + E : E) + "</span>")
            }
            this.picker.find(".datetimepicker-minutes td").html(b.join(""));
            var x = this.date.getUTCFullYear(),
                T = this.picker.find(".datetimepicker-months").find("th:eq(1)").text(r).end().find("span").removeClass("active");
            x == r && T.eq(this.date.getUTCMonth()).addClass("active"), (r < l || r > h) && T.addClass("disabled"), r == l && T.slice(0, c).addClass("disabled"), r == h && T.slice(p + 1).addClass("disabled"), b = "", r = parseInt(r / 10, 10) * 10;
            var N = this.picker.find(".datetimepicker-years").find("th:eq(1)").text(r + "-" + (r + 9)).end().find("td");
            r -= 1;
            for (var E = -1; E < 11; E++) b += '<span class="year' + (E == -1 || E == 10 ? " old" : "") + (x == r ? " active" : "") + (r < l || r > h ? " disabled" : "") + '">' + r + "</span>", r += 1;
            N.html(b)
        },
                ...
                switch (r[0].nodeName.toLowerCase()) {
                    case "th":
                        switch (r[0].className) {
                            ...
                            case "today":
                                var o = new Date;
                                o = t(o.getFullYear(), o.getMonth(), o.getDate(), o.getHours(), o.getMinutes(), o.getSeconds()), this.viewMode = this.startViewMode, this.showMode(0), this._setDate(o)
                        }
                        break;
                    case "span":
                        if (!r.is(".disabled")) {
                            if (r.is(".month")) {
                                ...
                                var u = r.parent().find("span").index(r);
                                this.viewDate.setUTCMonth(u), this.element.trigger({
                                    type: "changeMonth",
                                    date: this.viewDate
                                })
                            } else if (r.is(".year")) {
                                this.viewDate.setUTCDate(1);
                                var a = parseInt(r.text(), 10) || 0;
                                this.viewDate.setUTCFullYear(a), this.element.trigger({
                                    type: "changeYear",
                                    date: this.viewDate
                                })
                            } else if (r.is(".hour")) {
                                ...
                                this._setDate(t(a, u, l, f, c, h, 0))
                            } else if (r.is(".minute")) {
                                var c = parseInt(r.text().substr(r.text().indexOf(":") + 1), 10) || 0,
                                    a = this.viewDate.getUTCFullYear(),
                                    u = this.viewDate.getUTCMonth(),
                                    l = this.viewDate.getUTCDate(),
                                    f = this.viewDate.getUTCHours(),
                                    h = this.viewDate.getUTCSeconds();
                                this._setDate(t(a, u, l, f, c, h, 0))
                            }
                            if (this.viewMode != 0) {
                    ...
                    case "td":
                        if (r.is(".day") && !r.is(".disabled")) {
                            var l = parseInt(r.text(), 10) || 1,
                                ...
                                c = this.viewDate.getUTCMinutes(),
                                h = this.viewDate.getUTCSeconds();
                            r.is(".old") ? u === 0 ? (u = 11, a -= 1) : u -= 1 : r.is(".new") && (u == 11 ? (u = 0, a += 1) : u += 1), this._setDate(t(a, u, l, f, c, h, 0))
                        }
                        var p = this.viewMode;
                        this.showMode(-1), this.fill(), p == this.viewMode && this.autoclose && this.hide()
                }
        ...
        _setDate: function (e, t) {
            ...
            var n;
            this.isInput ? n = this.element : this.component && (n = this.element.find("input")), n && (n.change(), this.autoclose && (!t || t == "date"))
        },
        moveHour: function (e, t) {
            if (!t) return e;
            var n = new Date(e.valueOf());
            return t = t > 0 ? 1 : -1, n.setUTCHours(n.getUTCHours() + t), n
        },
        moveDate: function (e, t) {
            if (!t) return e;
            var n = new Date(e.valueOf());
            return t = t > 0 ? 1 : -1, n.setUTCDate(n.getUTCDate() + t), n
        },
        ...
        return n.shift(), this.each(function () {
            var i = e(this),
                ...
                o = typeof t == "object" && t;
            s || i.data("datetimepicker", s = new r(this, e.extend({}, e.fn.datetimepicker.defaults, o))), typeof t == "string" && typeof s[t] == "function" && s[t].apply(s, n)
        })
    }, e.fn.datetimepicker.defaults = {}, e.fn.datetimepicker.Constructor = r;
    var i = e.fn.datetimepicker.dates = {
        en: {
            ...
            validParts: function (e) {
                if (e == "standard") return /hh?|ii?|ss?|dd?|mm?|MM?|yy(?:yy)?/g;
            ...
            parseDate: function (n, s, o, u) {
                ...
                /^\d{4}\-\d{1,2}\-\d{1,2}$/.test(n) && (s = this.parseFormat("yyyy-mm-dd", u)), /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}$/.test(n) && (s = this.parseFormat("yyyy-mm-dd hh:ii", u)), /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}\:\d{1,2}[Z]{0,1}$/.test(n) && (s = this.parseFormat("yyyy-mm-dd hh:ii:ss", u));
                if (/^[-+]\d+[dmwy]([\s,]+[-+]\d+[dmwy])*$/.test(n)) {
                    ...
                    return t(n.getUTCFullYear(), n.getUTCMonth(), n.getUTCDate(), n.getUTCHours(), n.getUTCMinutes(), n.getUTCSeconds())
                }
                var l = n && n.match(this.nonpunctuation) || [],
                    n = new Date(0, 0, 0, 0, 0, 0),
                    d = {}, v = ["hh", "h", "ii", "i", "ss", "s", "yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"],
                    m = {
                        hh: function (e, t) {
                ...
                m.M = m.MM = m.mm = m.m, m.dd = m.d, n = t(n.getFullYear(), n.getMonth(), n.getDate(), n.getHours(), n.getMinutes(), n.getSeconds());
                if (l.length == s.parts.length) {
                    for (var p = 0, b = s.parts.length; p < b; p++) {
                        g = parseInt(l[p], 10), c = s.parts[p];
                        if (isNaN(g)) switch (c) {
                                case "MM":
                    ...
                    for (var p = 0, w; p < v.length; p++) w = v[p], w in d && !isNaN(d[w]) && m[w](n, d[w])
                }
                return n
            },
            formatDate: function (t, n, r, o) {
                ...
                if (o == "standard") u = {
                        ...
                        i: t.getUTCMinutes(),
                        s: t.getUTCSeconds()
                }, u.hh = (u.h < 10 ? "0" : "") + u.h, u.ii = (u.i < 10 ? "0" : "") + u.i, u.ss = (u.s < 10 ? "0" : "") + u.s, u.dd = (u.d < 10 ? "0" : "") + u.d, u.mm = (u.m < 10 ? "0" : "") + u.m;
                else {
                    ...
                    u = {
                        ...
                        i: t.getUTCMinutes(),
                        s: t.getUTCSeconds()
                    }, u.m = (u.n < 10 ? "0" : "") + u.n, u.d = (u.j < 10 ? "0" : "") + u.j, u.A = u.a.toString().toUpperCase(), u.h = (u.g < 10 ? "0" : "") + u.g, u.H = (u.G < 10 ? "0" : "") + u.G, u.i = (u.i < 10 ? "0" : "") + u.i, u.s = (u.s < 10 ? "0" : "") + u.s
                }
                var t = [],
                    a = e.extend([], n.separators);
                for (var f = 0, l = n.parts.length; f < l; f++) a.length && t.push(a.shift()), t.push(u[n.parts[f]]);
                return t.join("")
            },
    ...
    s.template = '<div class="datetimepicker"><div class="datetimepicker-minutes"><table class=" table-condensed">' + s.headTemplate + s.contTemplate + s.footTemplate + "</table>" + "</div>" + '<div class="datetimepicker-hours">' + '<table class=" table-condensed">' + s.headTemplate + s.contTemplate + s.footTemplate + "</table>" + "</div>" + '<div class="datetimepicker-days">' + '<table class=" table-condensed">' + s.headTemplate + "<tbody></tbody>" + s.footTemplate + "</table>" + "</div>" + '<div class="datetimepicker-months">' + '<table class="table-condensed">' + s.headTemplate + s.contTemplate + s.footTemplate + "</table>" + "</div>" + '<div class="datetimepicker-years">' + '<table class="table-condensed">' + s.headTemplate + s.contTemplate + s.footTemplate + "</table>" + "</div>" + "</div>", e.fn.datetimepicker.DPGlobal = s
}(window.jQuery);
var _gaq = _gaq || [];
_gaq.push(["_setAccount", "UA-37477022-1"]), track = function () {
    ...
    t.parentNode.appendChild(e), track()
}), $(document).on("page:change", track);
var disqus_shortname = "infinum-web",
    disqus_developer = 1;
ready = function () {
    window.disqus_no_style = !0;
    var e = document.getElementsByTagName("script")[0];
    if ($("#disqus_thread").length !== 0) {
        var t = document.createElement("script");
        t.type = "text/javascript", t.async = !0, t.src = "http://" + disqus_shortname + ".disqus.com/embed.js", e.parentNode.appendChild(t)
    }
    if ($('a[href$="#disqus_thread"]').length !== 0) {
        var n = document.createElement("script");
        n.type = "text/javascript", n.async = !0, n.src = "http://" + disqus_shortname + ".disqus.com/count.js", e.parentNode.appendChild(n)
    }
}, $(document).ready(ready), $(document).on("page:change", ready), window.H = function () {
    return {
        isMobile: {
            Android: function () {
        ...
        mobile: {
            version: {
                android: function () {
                    ...
                    return parseFloat(e.slice(e.indexOf("Android") + 8), 10)
                }
            },
            isChrome: function () {
                var e = navigator.userAgent;
...
}(), $(document).on("page:load DOMContentLoaded", function () {
    var e = $(document),
        t = $(".nav-fixed"),
        n = $(".menu-dongle");
    (!H.isMobile.iPad() || H.isMobile.Android()) && e.on("scroll", function () {
        e.scrollTop() > 0 ? (t.addClass("sticky"), n.addClass("sticky")) : (t.removeClass("sticky"), n.removeClass("sticky"))
    }), H.isMobile.any() && setTimeout(function () {
        window.scrollTo(0, 1)
    }, 0), Toucher = function () {
        var e = 50,
            t = {};
        return {
            bind: function (n) {
                var r = $(document);
                r.on("touchstart", n, function () {
                    var r = this;
                    t[n] = setTimeout(function () {
                        $(r).addClass("active")
                    }, e)
                }), r.on("touchend", n, function () {
                    clearTimeout(t[n]), $(this).removeClass("active")
                }), r.on("touchmove", n, function () {
                    clearTimeout(t[n]), $(this).removeClass("active")
                }), r.on("touchcancel", n, function () {
                    clearTimeout(t[n]), $(this).removeClass("active")
                })
            }
        }
    ...
    var r = function () {
        function n(n) {
            ...
            var r = n.state,
                i = 200;
            r = r || t, r ? e.slideUp(i) : e.slideDown(i), t = !r
        }
        var e = $(".menu-slidedown"),
            t = e.is(":visible");
        return {
            toggle: n,
            isShown: function () {
    ...
    $(".content, footer").on("touchstart", function (e) {
        r.isShown() && (r.toggle({
            state: !1
        }), e.preventDefault())
    }), $(".menu-button").on("click", function () {
        r.toggle()
    }), $(".menu-slidedown .outer-nav").on("click", function (e) {
        e.preventDefault();
        var t = $(this).data("url");
        window.location = t
    }), H.isMobile.any() && $(".back-to-top").on("click", function (e) {
...
function (e) {
    ...
    function E() {
        i(document, a.move, b), i(document, a.cancel, w)
    }
    function S(e) {
        var t, n;
        if (u[e.target.tagName.toLowerCase()]) return;
...
function (e) {
    ...
    return c.addTest = function (e, t) {
        ...
        return c
    }, r(""), v = g = null, c._version = l, c._domPrefixes = E, c._cssomPrefixes = w, c.testProp = function (e) {
        return u([e])
    }, c.testAllProps = f, p.className = p.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (h ? " js " + N.join(" ") : ""), c
}(this, this.document);
var Slider = function () {
    function d(t, i) {
        g(), e = $(t), h = e.parent().parent(), s = $(i), s.css({
            width: e.length * 26
        }), y(e.length), n = !0, m(), c && v();
        var o = $(t + ".active"),
            u = e.index(o);
        r = u === -1 ? 0 : u, b(r)
    }
    function v() {
        var t = new Image;
        $(".back", e).each(function (e, n) {
            var r = $(this).css("background-image").replace(/^url|[\(\)\"]/g, "");
            r && (t.src = r)
        })
    }
    function m() {
        $(".arrow-right, .arrow-left").off(), $(".arrow-right").on("click", function (e) {
            N(e)
    ...
    function g() {
        l || (l = $("html").hasClass("csstransitions"))
    }
    function y(e) {
        var t = "";
        for (var n = 0; n < e; n++) t += '<li data-slide="' + n + '"><div></div></li>';
        s.html(t), b(0), s.off(), s.on("click", "li", w), H.isMobile.any() || s.hasClass("hover-ok") || s.addClass("hover-ok")
    }
    function b(e) {
        var t = $($("li.active", s)[0]),
            n = $($("li", s)[e]);
    ...
    function w(n) {
        ...
        var u = $($("li.active", s)[0]),
            l = $(n.target),
            c = l;
        u.removeClass("active"), l.is("div") && (c = l.parent()), c.addClass("active"), L(), t = !1;
        var h = i;
        i = c.data().slide;
        if (h === i) {
            i = r + 1 >= e.length ? 0 : r + 1, f = setInterval(T, a);
            return
        }
        i < h && (p = !1), E(), f = setInterval(T, a)
    }
    function E() {
        var t = $(e[r]),
            n = $(e[i]);
        S(), b(i), o = !0, l ? (n.removeClass("active").addClass("next"), t.addClass("out"), setTimeout(x, u.fadeDur), p = !0) : (n.removeClass("active").addClass("next-no-anim"), t.fadeOut(u.fadeDur, function () {
            o = !1, t.removeClass("active"), n.removeClass("next-no-anim").addClass("active"), t.attr("style", ""), n.attr("style", ""), r = i, p = !0
        }))
    }
    function S() {
        p ? h.removeClass("backer") : h.addClass("backer")
    }
    function x() {
        o = !1;
        var t = $(e[r]),
            n = $(e[i]);
        t.removeClass("active out"), n.removeClass("next").addClass("active"), t.attr("style", ""), n.attr("style", ""), r = i
    }
    function T() {
        t = !0, r = r === -1 ? 0 : r, r = r >= e.length ? 0 : r, i = r + 1 >= e.length ? 0 : r + 1, E()
    }
    function N(e) {
        L(), p = !0, T(), e.preventDefault(), f = setInterval(T, a)
    }
    function C() {
        t = !0, r = r === -1 ? 0 : r, r = r >= e.length ? 0 : r, i = r - 1 < 0 ? e.length - 1 : r - 1, E()
    }
    function k(e) {
        L(), p = !1, C(), e.preventDefault(), f = setInterval(T, a)
    }
    function L() {
        t = !1, n = !1, clearInterval(f)
    }
    var e, t = !1,
        n = !1,
        r = 0,
    ...
    return {
        init: function (e, t, r) {
            ...
            n || (d(e, t), r = r || u.fadeDur + 5e3, a = u.fadeDur + r, f = setInterval(T, a))
        },
        next: function () {
            T()
        },
...
admin_init = function () {
    ...
    $("#users_sort tbody").sortable({
        helper: e,
        axis: "y",
        update: function () {
            $.post("/users/sort", $(this).sortable("serialize"))
        }
    }).disableSelection(), $("#datetimepicker").datetimepicker({
        format: "dd.mm.yyyy, hh:ii",
        todayBtn: !0,
        autoclose: !0,
        weekStart: 1
    }), $(".assign-contact-user-form select").change(function () {
        $(this).parents("form").submit()
    })
}, $(document).ready(admin_init), $(document).on("page:load page:change", admin_init),
function () {
...
function () {
    (function (e, t) {
        return typeof define == "function" && define.amd ? define(["jquery", "waypoints"], t) : t(e.jQuery)
    })(this, function (e) {
        var t;
        return t = {
            container: "auto",
        ...
        }, e.waypoints("extendFn", "infinite", function (n) {
            var r;
            n = e.extend({}, e.fn.waypoint.defaults, t, n), r = n.container === "auto" ? this : e(n.container);
            var i = n.nextPageUrl;
            return n.handler = function (t) {
                var s;
                if (t === "down" || t === "right") return s = e(this), n.onBeforePageLoad(), s.waypoint("disable"), e(".all-work .trigger").removeClass("trigger"), r.addClass(n.loadingClass), e(".all-work .loading").show(), e.get(i, function (t, r, o) {
                        return i = o.getResponseHeader("next_page_url"), e(".all-work .projects").append(t), e(".all-work .loading").hide(), t.length > 1 ? (s.waypoint("destroy"), e(".all-work .trigger").waypoint("infinite", {
                            nextPageUrl: i
                        })) : s.waypoint("destroy"), n.onAfterPageLoad()
                    })
            }, this.waypoint(n)
        })
    })
}.call(this), jQuery.support.placeholder = function () {
    var e = document.createElement("input");
    return "placeholder" in e
}(), slider = function () {
    var e = !0;
    H.isMobile.Android() ? H.mobile.version.android() >= 3 || (e = !1) : $("html").addClass("position-fixed"), e && Slider.init(".home .slide", ".pagination")
    ...
    var e, t, n;
    typeof document.hidden != "undefined" ? (e = "hidden", n = "visibilitychange", t = "visibilityState") : typeof document.mozHidden != "undefined" ? (e = "mozHidden", n = "mozvisibilitychange", t = "mozVisibilityState") : typeof document.msHidden != "undefined" ? (e = "msHidden", n = "msvisibilitychange", t = "msVisibilityState") : typeof document.webkitHidden != "undefined" && (e = "webkitHidden", n = "webkitvisibilitychange", t = "webkitVisibilityState"), slider(), $.support.placeholder || placeholder(), initInfiniteScroll()
}, initInfiniteScroll = function () {
    $(".all-work .trigger").waypoint("infinite", {
        nextPageUrl: $(".all-work").data("source")
    })
}, ready = function () {
    var e = $(document);
    init(), e.on("click", "a[data-popup]", function (e) {
        window.open($(this)[0].href), e.preventDefault()
    }), H.isMobile.iPad() && (e.on("focus", "input[type=text], textarea", function () {
        $(".nav-fixed, .menu-dongle").css("position", "absolute")
    }), e.on("blur", "input[type=text], textarea", function () {
        $(".nav-fixed, .menu-dongle").css("position", "fixed")
    }))
}, $(document).ready(ready), $(document).on("page:load page:change", init);